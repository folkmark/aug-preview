...
Twenty bios are on the site, one page each at the `bioUrl` above: the four leaders and
sixteen partners and fellows. Their prose lives in `source-material/bios/<slug>.md` and
nowhere else — deliberately not in this export, so there is only one copy to keep
current. See [`../sections/leadership.md`](../sections/leadership.md). The other nine
